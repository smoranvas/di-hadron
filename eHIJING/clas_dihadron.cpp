...
//Sebouh's analysis
std::vector<double> dphibins({0, pi/8, 2*pi/8, 3*pi/8, 4*pi/8, 5*pi/8, 6*pi/8, 7*pi/8, 8*pi/8});
std::vector<double> dYbins({-0.5, 0.5, 1.5, 2.5});
std::vector<double> pT1bins({0.25, 0.4, 0.6, 1.0});
std::vector<double> pT2bins({0.25, 0.4, 0.6, 0.8});
...
bool trigger(Pythia & pythia) {
    ...
    return (y<0.85) & (1.0<Q2) & (2.3<nu) & (nu<4.2) & (W2>4.);
